...
import { adminSidebar } from '@/layouts/hydrogen/adminSidebar';
import { superAdminSidebar } from '@/layouts/hydrogen/superAdminSidebar';
import StatusBadge from '@/components/get-status-badge';
import { useSession } from 'next-auth/react';
import { permissionDrawerData } from '@/utils/constants/page';

export function SidebarMenu() {
  const session = useSession() as any;
  const isSuperAdmin = session?.data?.user?.data?.permissions?.find(
    (permission: any) => permission?.resource === 'admin'
  );
