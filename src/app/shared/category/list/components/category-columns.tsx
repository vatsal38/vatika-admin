      ...
      <div className="flex items-center justify-end gap-3 pe-4">
        ...
        >
          <div className="flex items-center justify-end gap-3 pe-4">
            <Button
              variant="outline"
              className="mr-2 flex w-full items-center justify-start gap-2 p-2 hover:bg-gray-100 focus:outline-none dark:hover:bg-gray-50"
              onClick={() =>
                openDrawer({
                  view: (
                    <>
            ...
            >
              <HiOutlineInformationCircle className="h-4 w-4" /> Sub Category
            </Button>
          </div>
        </Tooltip>
      </div>
